...
class Menu:
    def __init__(self, window):
        ...
        self.surf = pygame.image.load('./asset/background2.jpg')
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(50, "Paulão", (COLOR_ORANGE), ((WIN_WIDTH / 2), 70))
            self.menu_text(50, "Contra Ataca", (COLOR_ORANGE), ((WIN_WIDTH / 2), 120))
